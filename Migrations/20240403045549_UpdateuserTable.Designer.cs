...
namespace infraAlerta.Migrations
{
    ...
    [Migration("20240403045549_UpdateuserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("infraAlerta.Models.User_address", b =>
                {
                    ...
                    b.Property<int>("ua_useruser_id")
                        .HasColumnType("int");

                    b.HasKey("ua_id");

                    b.HasIndex("ua_useruser_id");
            ...
            modelBuilder.Entity("infraAlerta.Models.User_address", b =>
                {
                    b.HasOne("infraAlerta.Models.User", "ua_user")
                        .WithMany()
                        .HasForeignKey("ua_useruser_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
